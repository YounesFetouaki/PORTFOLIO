      ...
      <div>
        <div className="grid md:grid-cols-2 my-8 sm:my-20 gap-14">
          ...
          <div className="flex justify-center flex-col tracking-[1px] text-xl gap-5">
            <p>
            My name is Younes Fetouaki. I will graduate in Software Engineering from UPM around 2024. 
            I work as a web developer and freelancer. 
            My hobbies include watching movies, series, playing video games, and occasionally cooking.
            </p>
            <p>
